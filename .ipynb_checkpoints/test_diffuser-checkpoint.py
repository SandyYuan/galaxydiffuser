...
class TrainingConfig:
    ...
    hub_model_id = "sandyyuan/galaxyfactorycropped1"  # the name of the repository to create on the HF Hub
...
if __name__ == '__main__':
    ...
    test_dataloader = torch.utils.data.DataLoader(testdataset, batch_size=config.eval_batch_size, shuffle=True)
